# Contributing to Pqcoin Core

Pqcoin Core is open source software, and we would welcome contributions
which improve the state of the software. For those wanting to discuss changes,
or look for work that needs doing, please see:

* [Help requests](https://github.com/pqcoin/pqcoin/labels/help%20wanted)
* [Projects](https://github.com/pqcoin/pqcoin/projects)
* [Pqcoindev on reddit](https://www.reddit.com/r/pqcoindev/)

## Branch Strategy

Pqcoin Core's default branch is intentionally a stable release, so that anyone
...
Pqcoin Core is a direct fork of Bitcoin Core and therefore benefits from as
...
[bitcoin/bitcoin](https://github.com/bitcoin/bitcoin) and future Pqcoin Core
releases will automatically benefit from these.

When refactoring Pqcoin-specific code, please keep refactoring requests short,
low complexity and easy to verify.


## "Decision Making" Process

The following applies to code changes to Pqcoin Core, and is not to be
confused with overall Pqcoin Network Protocol consensus changes. All consensus
...
Whether a pull request is merged into Pqcoin Core rests with the repository
maintainers.

Maintainers will take into consideration if a patch is in line with the general
principles of Pqcoin; meets the minimum standards for inclusion; and will
...
that have demonstrated a deeper commitment and understanding towards Pqcoin
(over time) or have clear domain expertise may naturally have more weight, as
one would expect in all walks of life.

Where a patch set proposes to change the Pqcoin consensus, it must have been
