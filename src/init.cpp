...
void Shutdown()
{
    ...
    StopHTTPServer();
#ifdef ENABLE_WALLET
    // Pqcoin 1.14 TODO: ShutdownRPCMining();
    if (pwalletMain)
...
bool AppInitMain(boost::thread_group& threadGroup, CScheduler& scheduler)
{
    ...
    // Pqcoin: Do we need to do any RPC mining init here?
