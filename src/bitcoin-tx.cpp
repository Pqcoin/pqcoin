...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s pqcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  pqcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded pqcoin transaction") + "\n" +
              "  pqcoin-tx [options] -create [commands]   " + _("Create hex-encoded pqcoin transaction") + "\n" +
              "\n";
