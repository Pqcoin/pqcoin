...
/** Recommended transaction fee by Pqcoin Core developers
  *
...
static const unsigned int DEFAULT_BLOCK_MAX_SIZE = 30000000;
/** Default for -blockprioritysize, maximum space for zero/low-fee transactions **/
static const unsigned int DEFAULT_BLOCK_PRIORITY_SIZE = 30000000;
/** Default for -blockmaxweight, which controls the range of block weights the mining code will create **/
static const unsigned int DEFAULT_BLOCK_MAX_WEIGHT = 120000000;
/** Default for -blockmintxfee, which sets the minimum feerate for a transaction in blocks created by mining code **/
static const unsigned int DEFAULT_BLOCK_MIN_TX_FEE = (unsigned int) RECOMMENDED_MIN_TX_FEE;
/** The maximum weight for transactions we're willing to relay/mine */
static const unsigned int MAX_STANDARD_TX_WEIGHT = 400000000;
 ...
 *
 *  Pqcoin:    Increment mempool limits and accept RBF in steps of 0.0001 PQ
...
/**
 * Pqcoin: Default dust limit that is evaluated when considering whether a
...
/**
 * Pqcoin: Default hard dust limit that is evaluated when considering whether
