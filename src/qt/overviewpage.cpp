...
void OverviewPage::UpdateTip()
{
    QStringList tips = {
        ...
        tr("To see ongoing development and contribute, check out the Pqcoin Core repository on GitHub"),
        tr("Services that claim to double your pqcoins are always ponzi schemes")
    };
