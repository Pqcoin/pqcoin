...
// Copyright (c) 2020 The Pqcoin Core developers
...
void PaymentServerTests::paymentServerTests()
{
    ...
    // Pqcoin: Disable certificate tests as we don't touch this code, and building test
    ...
    /* PL: This doesn't work for Pqcoin (as there is no actual maximum coins)
